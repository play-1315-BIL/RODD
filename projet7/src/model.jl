function generate_model(instance::Instance, initial_states::Array{Int64, 1})
    ...
    @objective(model, Min, sum(x[initial_states[p], v, 1, p] for p=1:P for v in delta_plus[initial_states[p]] if is_legal(u, v, 1)))
